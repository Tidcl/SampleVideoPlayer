...
bool H264Source::HandleFrame(MediaChannelId channel_id, RTPFrame frame)
{
...
uint32_t H264Source::GetTimestamp()
{
    /* #if defined(__linux) || defined(__linux__)
        ...
        return ts;
    #else  */
    auto time_point = std::chrono::time_point_cast<chrono::microseconds>(std::chrono::steady_clock::now());
